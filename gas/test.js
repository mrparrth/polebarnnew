...
function testNewProject() {
  ...
  let data = {
    ...
    additionalinformationnotes: 'sample',
    windspeed: '145MPH',
    state: 'AL',
    postsizepartialyenclosed: '',
    addonsleantopostsizepartialyenclosepolebarn: '',
    addonsleantosizepartialyenclosedpolebarn: '',
...
function testInvoiceCreation() {
  let data = {
    addonsleantopitchpartialyenclosedpolebarn: '',
    metalroofpanelgaugeopenpolebarn: '29 GAUGE',
    connectslabtrussonly: '',
    postspacingenclosedpole: '',
    addonsleantopostsizeopenpolebarn: '',
    addonsforwindowssizepartialyenclosedpolebarn: '',
    siteaddress: 'PARCEL ID# 3707250000006.005',
    partialyenclosedsize: '',
    signature: 'TASHA LEE',
    maibbldgpitchpartialyenclosed: '',
    plywoodonroof: 'No',
    ...
    additionalinformationnotes:
      'ALABAMA STAMPED Typical open pole barn plan with customer name, address and barn size in title block\nPhysical copy',
    orderedby: 'TASHA LEE',
    zip: '36544',
    metalroofpanelgaugetrussonly: '',
    addonsfordoorssizeenclosedpole: '',
    ...
    addonsforwindowssizeenclosedpole: '',
    postsizetrussonly: '',
    addonsleantoslabopenpolebarnpitch: 'N/A',
    addonsfordoorssizepartialyenclosedpolebarn: '',
    metalroofpanelgaugepartialyenclosed: '',
    exposurecategory: 'B',
    addonsforwindowsquantitypartialyenclosedpolebarn: '',
    ...
    maibbldgpitchtrussonly: '',
    postsizepartialyenclosed: '',
    connectslabopenpolebarn: 'N',
    studspacingcustomvalue: 'STANDARD SPACING',
    postsizeopenpolebarn: '6X6',
    city: 'IRVINGTON',
    projectpricing: '180',
    addonsleantoopenpolebarnsize: '',
    addonsfordoorsquantityenclosedpole: '',
    cname: 'NICHOLAS NASSAR',
    projectid: '000.58',
    driveFolder: 'https://drive.google.com/drive/folders/1xm9wHCQRARnLM7Xg8Eqo4DH2D8A_iIn-',
  }

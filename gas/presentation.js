...
function generatePresentation(projectData) {
  ...
  if (Object.keys(chartData).length == 0) {
    errors.push(`There is no chart data for Wind Speed - ${projectData.windspeed}, Exposure ${projectData.exposurecategory}, Width - ${width}, Height - ${height}`)
  }
  ...
  let presOPB = _createNewSlideFromTemplate_(allData.cname, allData.projectname)
